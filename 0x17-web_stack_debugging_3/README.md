...
-   You can use [tmux](https://intranet.hbtn.io/rltoken/Y88Pu9i5r6_G3AID5KplQQ "tmux") to run [strace](https://intranet.hbtn.io/rltoken/OUc10nTtuZG65adFVbkYag "strace") in one window and `curl` in another one
